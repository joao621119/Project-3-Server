...
// With veet we dont use localhost 3000, instead we use 5173. Change it on the .env also!
...
module.exports = (app) => {
  ...
  app.use(
    // Control Origin Request Source. The cors will only be active if you need a specific key
    cors({
      origin: [FRONTEND_URL],
    })
  );
